...
HD_PWD='C:/Users/kmejbaulislam/Documents/Research/Dipal_project/d_pin_skew/d_pin_skew.runs/systolic_4x4_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systolic_4x4_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systolic_4x4_0.tcl
