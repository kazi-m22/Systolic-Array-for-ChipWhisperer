...
set_property PACKAGE_PIN A12 [get_ports {debug[0]}]
...
set_property PACKAGE_PIN A14 [get_ports {debug[2]}]

set_property DRIVE 8 [get_ports {debug[3]}]
set_property PACKAGE_PIN A15 [get_ports {debug[3]}]

set_property DRIVE 8 [get_ports {debug[4]}]
set_property PACKAGE_PIN B12 [get_ports {debug[4]}]

set_property DRIVE 8 [get_ports {debug[5]}]
set_property PACKAGE_PIN B14 [get_ports {debug[5]}]

set_property DRIVE 8 [get_ports {debug[6]}]
set_property PACKAGE_PIN B15 [get_ports {debug[6]}]

set_property DRIVE 8 [get_ports {debug[7]}]
set_property PACKAGE_PIN B16 [get_ports {debug[7]}]

set_property DRIVE 8 [get_ports {debug[8]}]
set_property PACKAGE_PIN C11 [get_ports {debug[8]}]

set_property DRIVE 8 [get_ports {debug[9]}]
set_property PACKAGE_PIN C12 [get_ports {debug[9]}]


set_property DRIVE 8 [get_ports {debug[10]}]
set_property PACKAGE_PIN C13 [get_ports {debug[10]}]

set_property DRIVE 8 [get_ports {debug[11]}]
set_property PACKAGE_PIN C14 [get_ports {debug[11]}]

set_property DRIVE 8 [get_ports {debug[12]}]
set_property PACKAGE_PIN C16 [get_ports {debug[12]}]

set_property DRIVE 8 [get_ports {debug[13]}]
set_property PACKAGE_PIN D13 [get_ports {debug[13]}]

set_property DRIVE 8 [get_ports {debug[14]}]
set_property PACKAGE_PIN D15 [get_ports {debug[14]}]

set_property DRIVE 8 [get_ports {debug[15]}]
set_property PACKAGE_PIN D16 [get_ports {debug[15]}]

set_property DRIVE 8 [get_ports {debug[16]}]
set_property PACKAGE_PIN G16 [get_ports {debug[16]}]

set_property DRIVE 8 [get_ports {debug[17]}]
set_property PACKAGE_PIN H16 [get_ports {debug[17]}]

set_property DRIVE 8 [get_ports {debug[18]}] 
set_property PACKAGE_PIN E11 [get_ports {debug[18]}]

set_property DRIVE 8 [get_ports {debug[18]}] 
set_property PACKAGE_PIN E13 [get_ports {debug[19]}]
 
set_property DRIVE 8 [get_ports {debug[18]}] 
set_property PACKAGE_PIN E15 [get_ports {debug[20]}]
